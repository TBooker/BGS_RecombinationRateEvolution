...
win_10000 <- getWindowDataFrame(raw_10000, "10 Kbp")
...
win_100000 <- getWindowDataFrame(raw_100000, "100 Kbp")
...
win_1000000 <- getWindowDataFrame(raw_1000000, "1 Mbp")
...
pdf("~/UBC/Mouse_BGS_RecombinationRateEvolution/Plots/pi_r_correlationOverTime.pdf", height = 8, width = 5)
print(corPlot)
dev.off()

allDat <- rbind(win_100000)
...
pdf("~/UBC/Mouse_BGS_RecombinationRateEvolution/Plots/pi_r_correlationOverTime_bothMaps.pdf", height = 8, width = 4)
print(Figure2)
dev.off()
